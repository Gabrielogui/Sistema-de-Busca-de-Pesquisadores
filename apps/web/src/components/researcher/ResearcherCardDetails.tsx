...
export default function ResearcherCardDetails() {
    return (
        <div className="flex gap-4 border border-slate-300 rounded-md w-full h-75">
            {/* IMAGEM DO PESQUISADOR */}
            <div className="relative w-70">
                <Image src="https://picsum.photos/200/300" fill alt="Imagem do pesquisador"
                    className="rounded-l-md object-cover object-center"></Image>
            </div>
            ...
            <div className="flex flex-col gap-2 p-2 w-full">
                <div className="flex flex-col">
                    <div className="flex justify-between items-center">
                        ...
                        <span className="p-2 bg-gray-100 rounded-full">Computação</span>
                    </div>
                    ...
                    <div className="flex items-center text-sm gap-2 text-gray-500">
                        <MapPin />
                        <span className="">Universidade do estado da Bahia</span>
                    </div>
                </div>
                ...
                <div className="flex gap-2 border-t p-2 justify-end w-full">
                    <Button variant="ghost">Visualizar mais</Button>
                </div>
